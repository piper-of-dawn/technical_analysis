...
var longform = document.querySelector( '.longform' );
headers=document.querySelectorAll('.longform>section');
    // Create a list for the ToC entries
    tocList = document.createElement("ul");

    // Get the h3 tags - ToC entries
for (i = 1; i < headers.length; i++){     
  headers[i].setAttribute("data-aos", "fade-up");
    headers[i].setAttribute("data-aos-duration", "2000");}
...
txt = "font-weight: bold; background: linear-gradient("+ angle +"deg" +", rgba(255, 255, 0, 0.2)"+ stop1+"%," + "rgba(255, 250, 150, 1.25)" +stop2+ "%, rgba(255, 250, 160, 0.5) 5.8%, rgba(255, 250, 205," + opacity + ")" + stop3 + "%, rgba(255, 250, 205,"+ opacity + ")" + stop4 + "%, rgba(250, 255, 130, 0.9) 98%), linear-gradient(190deg, rgba(255, 250, 205, 0) 0%, rgba(255, 250, 0, 0.3) 7.9%, rgba(255, 250, 205, 0) 15%); border-radius: 1em 0 2em 0;   -webkit-box-decoration-break: clone; margin: 0; text-shadow: -6px 6px 4.9px rgba(255,250,205,0.7), 21px -18.1px 7.3px rgba(255, 255, 255,1), -18.1px -27.3px 30px rgba(255, 255, 255,1);"
console.log(txt)
...
(function (document) {
  const markers = [...document.querySelectorAll('underline')];
